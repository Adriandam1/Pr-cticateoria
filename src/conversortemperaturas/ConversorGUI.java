    ...
    public ConversorGUI() {
        ...
        botonCelsius.addActionListener((ActionEvent e) -> {
            try {
                ...
                JOptionPane.showMessageDialog(ventana, "Por favor, ingrese un numero valido en Fahrenheit.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        botonFahrenheit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(ventana, "Por favor, ingrese un numero válido en Celsius.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
